...
(
    ...
    cloth_base_notes   varchar(255) not null,
    cloth_middle_notes varchar(255) not null,
    cloth_top_notes    varchar(255) not null,
    cloth_gender         varchar(255) not null,
...
create table users_cloth_list
(
    user_id         int8 not null,
    cloth_list_id int8 not null
);
...
alter table if exists users_cloth_list
    add constraint FK9neiuundys2yde15o8tcybbvw foreign key (cloth_list_id) references clothes;
alter table if exists users_cloth_list
